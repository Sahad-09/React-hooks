...
const usecontext = () => {
  return (
    <div>
        ...
        <div className='p-3'>
            <h1 className=' text-4xl border-b-2 border-[#0F1729] text-center bg-gradient-to-b from-[#18B4F7] to-[#C8CAD0] text-transparent bg-clip-text'>useContext</h1>


            <p>The useContext hook in React is a powerful tool that allows you to access and share state or functions across components without having to pass them down through props.</p>
            <div className=' my-8'>
